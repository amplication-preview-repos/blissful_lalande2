...
@InputType()
class ConfigurationCreateNestedManyWithoutProductsInput {
...
export { ConfigurationCreateNestedManyWithoutProductsInput as ConfigurationCreateNestedManyWithoutProductsInput };
