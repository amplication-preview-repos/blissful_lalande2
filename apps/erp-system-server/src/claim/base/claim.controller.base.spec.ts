  ...
  test("POST /claims", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        resolvedDate: CREATE_RESULT.resolvedDate.toISOString(),
      ...
      .expect([
        {
          ...
          resolvedDate: FIND_MANY_RESULT[0].resolvedDate.toISOString(),
  ...
  test("GET /claims/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        resolvedDate: FIND_ONE_RESULT.resolvedDate.toISOString(),
