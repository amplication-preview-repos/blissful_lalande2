...
@InputType()
class ShipmentCreateNestedManyWithoutInventoriesInput {
...
export { ShipmentCreateNestedManyWithoutInventoriesInput as ShipmentCreateNestedManyWithoutInventoriesInput };
