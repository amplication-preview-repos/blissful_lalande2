...
@InputType()
class ComponentUpdateManyWithoutConfigurationsInput {
...
export { ComponentUpdateManyWithoutConfigurationsInput as ComponentUpdateManyWithoutConfigurationsInput };
