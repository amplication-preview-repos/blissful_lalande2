...
@InputType()
class ComponentCreateNestedManyWithoutConfigurationsInput {
...
export { ComponentCreateNestedManyWithoutConfigurationsInput as ComponentCreateNestedManyWithoutConfigurationsInput };
